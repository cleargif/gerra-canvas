...
(function ($) {
  ...
  $.ThreeSixty = function (el, options) {
    ...
    base.initProgress = function() {
      ...
      try {
        ...
        cl.setColor(AppCongif.spinnerColor);
        cl.setDiameter(52);
        cl.setDensity(58);
        cl.setRange(0.7);
        cl.setFPS(25);
        ...
        // comented as it was displaying error in IE
    ...
    base.initEvents = function () {
      ...
      $(document).bind('mousemove', function (event) {
        if (AppCongif.dragging) {
          ...
          if(!$.browser.msie) {
            //base.$el.css("cursor", "url(assets/hand_open.png), auto");
          }
        }
        base.trackPointer(event);
  ...
  $.ThreeSixty.defaultOptions = {
    ...
    autoplay: false,
    /**
     * @cfg {String} spinnerColor[#000000]
     * Change the color of the spinning disk
     */
    spinnerColor : '#000000',
    /**
     * @cfg {Function} loaded
...
//jsduck-4.0.beta.exe --output docs/ --ignore-global --title="360 Image Slider" javascripts/threesixty.js

//jsduck-4.0.beta.exe --output docs/ --ignore-global --title="360 Image Slider" --examples-base-url=/ --eg-iframe=eg-iframe.html --guides=guides.json --welcome=welcome.html --examples=examples.json javascripts/threesixty.js